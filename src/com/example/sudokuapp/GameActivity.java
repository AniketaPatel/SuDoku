...
import com.example.sudokuapp.Keypad;
import com.example.sudokuapp.R;

import com.example.sudokuapp.PuzzleView;
...
public class GameActivity extends Activity {
	...
	private static final String TAG = "Sudoku";
	   ...
	   public static int setTile = 0;
	   
	   private final String demoPuzzle=
			   "362501479914237856785694231"+
               "179402583823759614546813927"+
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//setContentView(R.layout.activity_game);
		 Log.d(TAG, "onCreate");
	      ...
	      puzzleView = new PuzzleView(GameActivity.this);
	...
	/** Given a difficulty level, come up with a new puzzle */
	   private int[] getPuzzle(int diff) {
	     ...
	     // Toast.makeText(this, ""+setTile, Toast.LENGTH_LONG).show();
	   ...
	   private int getTile(int x, int y) {
	      //Toast.makeText(this, "Hi this is", Toast.LENGTH_LONG).show();
		   return puzzle[y * 9 + x];
	   }
